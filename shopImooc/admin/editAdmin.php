	...
	<form action="doAdminAction.php?act=editAdmin" method="post">
		<table width="70%" border="1" cellpadding="5" cellspacing="0"
			...
			<tr>
				...
				<td><input type="text" name="username" placeholder="请输入管理员名称" value="<?php echo $row["username"]?>"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="email" placeholder="请输入管理员邮箱" value="<?php echo $row["email"]?>" /></td>
			</tr>
			<tr>
